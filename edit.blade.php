                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="inpkode"
                                    ...
                                    @error('kode')
                                        is-invalid
                                    @enderror"
                                    name="example-text-input" placeholder="Masukkan Kode Inventaris" value="{{ $sarpras->kode }}">
                                @error('kode')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="inpbarang"
                                    ...
                                    @error('barang')
                                        is-invalid
                                    @enderror"
                                    name="example-text-input" placeholder="Input Nama Barang" value="{{ $sarpras->barang }}">
                                @error('barang')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="inplokasi"
                                    ...
                                    @error('lokasi')
                                        is-invalid
                                    @enderror"
                                    name="example-text-input" placeholder="Input Lokasi" value="{{ $sarpras->lokasi }}">
                                @error('lokasi')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
